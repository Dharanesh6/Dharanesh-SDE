      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="mt-1.5 text-slate-400 light:text-slate-600 text-xs sm:text-sm max-w-lg">
            7 verified prize wins and 10 state/national symposium participations.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`p-4 rounded-xl transition-all border ${
                  isFirstPrize
                    ? 'bg-gradient-to-br from-dark-card to-amber-950/20 light:from-white light:to-amber-50/50 border-amber-500/30'
                    : 'bg-dark-surface/70 light:bg-white border-white/5 light:border-slate-200'
                }`}
              >
                ...
                <h4 className="font-display font-bold text-sm text-white light:text-slate-900 leading-snug">
                  {item.title}
                </h4>
